...
4. Sonra ilgilendiğin modülün kılavuzu (Faz 3–6, hazır oldukça eklenecek).
...
| 2 | 3 | `03-modul-accounts-core-config.md` | Hesaplar, rol decorator'ları, çekirdek yardımcılar, ayarlar ve URL yapılandırması | Sırada |
| 2 | 4 | `04-modul-shops.md` | Dükkan modelleri, çalışma saatleri, vitrin ve arama mantığı | Sırada |
