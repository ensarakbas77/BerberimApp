...
| 2026-09-19 | Supabase/Vercel bağlayıcıları yalnızca salt okunur kullanılır (RLS/Data API kontrolü, log okuma); şemanın tek sahibi Django migration'ları; şifre, `DATABASE_URL` ve env girişleri kullanıcıda (§12) | Tek şema kaynağı; gizli bilgi koda ve araçlara girmesin |
